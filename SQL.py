...
SQL_PROP_POR_ID = 'SELECT ID_PROP, NOME, CPF, RG, ENDERECO, TELEFONE, EMAIL from proprietarios where ID_PROP=%s'
...
SQL_BUSCA_CORR_POR_ID = 'SELECT ID_CORR, USUARIO, EMAIL,NOME,IMOBIL,CRECI,CELULAR,CPF,ENDERECO,SENHA from corretores where ID_CORR=%s'
